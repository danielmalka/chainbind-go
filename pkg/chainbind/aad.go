...
// wire vocabulary; JCS canonicalizes the object so Go struct field order
...
// "tenant_id", "environment"}). The returned bytes are the additional
// authenticated data AES-256-GCM.Seal/Open is fed: GCM authentication fails
// if a segment is moved to another package_id or renamed to another
// segment, which is the anti-splicing control this AAD construction exists
// to provide.
